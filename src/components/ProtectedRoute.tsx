...
export function ProtectedRoute({ children, requiredRole }: ProtectedRouteProps) {
  const { user, isLoading, isRoleLoading, isCandidate, isRecruiter, isAdmin, userStatut } = useAuth();
  ...
  // Check user status - block if not 'actif'
  if (user && userStatut && userStatut !== 'actif') {
