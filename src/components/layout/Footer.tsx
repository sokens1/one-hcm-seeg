        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-lg font-bold text-foreground">OneHCM</h3>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <a href="/recruiter" className="block text-sm text-muted-foreground hover:text-primary transition-colors">
                Espace recruteur
              </a>
              <a href="#" className="block text-sm text-muted-foreground hover:text-primary transition-colors">
                À propos
          ...
          {/* About */}
          <div className="space-y-4">
            <h4 className="font-semibold text-foreground">OneHCM</h4>
            <p className="text-sm text-muted-foreground">
