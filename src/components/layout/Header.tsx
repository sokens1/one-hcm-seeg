  ...
  return (
    <>
      <header className="border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        {/* Bannière informative d'éligibilité - Toujours visible */}
        <div className="bg-red-700 text-yellow-400 mb-2">
          <div className="bg-white/10 py-2">
            <div className="container mx-auto flex items-center gap-2">
              <span className="font-bold text-sm whitespace-nowrap pl-4">IMPORTANT :</span>
              <div className="flex-1 overflow-hidden">
                <div className="relative flex">
                  <div className="animate-marquee whitespace-nowrap text-sm text-white">
                    Une nouvelle candidature n'est pas autorisée pour les candidats ayant précédemment postulé lors du recrutement des directeurs (profils déjà examinés et considérés). De plus, les agents SEEG en CDD dont le contrat expire après le 1er décembre sont non éligibles.
                  </div>
                  <div className="absolute top-0 animate-marquee2 whitespace-nowrap text-sm text-white">
                    Une nouvelle candidature n'est pas autorisée pour les candidats ayant précédemment postulé lors du recrutement des directeurs (profils déjà examinés et considérés). De plus, les agents SEEG en CDD dont le contrat expire après le 1er décembre sont non éligibles.
                  </div>
                </div>
              </div>
