              ...
              <CardContent className="p-3 sm:p-4">
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-xs sm:text-sm text-muted-foreground">Favorables</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-3 sm:p-4">
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-xs sm:text-sm text-muted-foreground">Mitigés</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-3 sm:p-4">
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-xs sm:text-sm text-muted-foreground">Non retenus</p>
                  </div>
                </div>
              </CardContent>
            </Card>
