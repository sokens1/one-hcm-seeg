  ...
  return (
    <Layout showFooter={true}>
      ...
      <div className="container mx-auto px-4 py-8" id="job-list">
        ...
        <div className="max-w-4xl mx-auto mb-8 sm:mb-12 px-4">
          <div className="bg-gradient-to-br from-green-600 to-emerald-600 text-white rounded-xl p-4 sm:p-6 md:p-8 shadow-lg">
            <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-white/20 rounded-lg flex items-center justify-center flex-shrink-0">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm sm:text-base md:text-lg opacity-90 mb-4 sm:mb-6 leading-relaxed">
                  Testez le système d'envoi d'email de confirmation de candidature en temps réel.
                ...
                <div className="space-y-4 bg-white/10 rounded-lg p-4">
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    <div>
                      <label className="text-xs font-medium text-white/80 block mb-1">Email de destination</label>
                      <Input
                        type="email"
                        placeholder="votre@email.com"
                        value={testEmail}
                        onChange={(e) => setTestEmail(e.target.value)}
                        className="h-9 text-sm bg-white/90 text-gray-900"
                      />
                    </div>
                    <div>
                      <label className="text-xs font-medium text-white/80 block mb-1">Prénom</label>
                      <Input
                        type="text"
                        placeholder="Prénom"
                        value={testFirstName}
                    ...
                    <div>
                      <label className="text-xs font-medium text-white/80 block mb-1">Titre du poste</label>
                      <Input
                        type="text"
                  ...
                  <Button 
                    ...
                    className="w-full sm:w-auto bg-white text-green-700 hover:bg-gray-200 font-semibold"
                  >
                    {isSendingTest ? (
                      <>
                  ...
                  <div className={`mt-4 p-3 rounded-lg ${
                    ...
                    {testResult.details && (
                      <details className="mt-2 text-xs opacity-80">
                        <summary className="cursor-pointer hover:opacity-100">Voir les détails</summary>
                        <pre className="mt-1 p-2 bg-black/20 rounded text-left overflow-x-auto">
