-- ============================================================================
-- UPDATE FINAL AVEC LES 28 CHAMPS COMPLETS DE JOB_OFFERS
-- ============================================================================
-- Exécutez cette requête dans votre BASE SOURCE
-- Copiez TOUTES les lignes UPDATE générées
-- Exécutez-les dans votre BASE DESTINATION
-- ============================================================================
...
SELECT 
    ...
    'profile = ' || CASE WHEN profile IS NULL THEN 'NULL' ELSE quote_literal(REPLACE(profile, '''', '''''')) END || ', ' ||
    ...
    -- Champs MTP Questions (TEXT[] arrays)
    ...
    -- Condition WHERE
    'WHERE id = ' || quote_literal(id::text) || '::uuid;' as UPDATE_COMPLET_28_CHAMPS
...
-- ============================================================================
-- CETTE REQUÊTE GÉNÈRE LES UPDATE POUR TOUS LES CHAMPS:
-- ============================================================================
-- ✅ description, location, contract_type
-- ✅ department, salary_min, salary_max
-- ✅ profile (CONNAISSANCES SAVOIR - ancien champ)
-- ✅ requirements (TEXT[] - nouveau champ pour connaissances)
-- ✅ benefits (TEXT[] - avantages)
-- ✅ responsibilities (TEXT[] - missions principales)
-- ✅ application_deadline, start_date, date_limite
