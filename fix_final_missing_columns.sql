-- Script final pour ajouter TOUTES les colonnes manquantes
...
AND (column_name LIKE 'simulation_%' OR column_name LIKE '%competences%' OR column_name LIKE '%kcis%' OR column_name LIKE '%kpis%')
