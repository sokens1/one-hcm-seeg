-- Script pour activer les candidatures en créant des offres d'emploi actives
-- Ce script va créer des offres d'emploi de test pour permettre aux candidats de postuler
...
-- Récupérer le premier recruteur/admin disponible
DO $$
DECLARE
    recruiter_id UUID;
    job_count INTEGER;
...
-- 5. Vérifier les politiques RLS pour les offres d'emploi
SELECT 
    schemaname,
    tablename,
    policyname,
...
DO $$
BEGIN
    RAISE NOTICE '✅ Activation des candidatures terminée !';
    RAISE NOTICE '🎯 Les candidats peuvent maintenant voir et postuler aux offres d''emploi';
