-- CORRECTION D'URGENCE ABSOLUE POUR RLS
-- Cette migration force la désactivation de RLS de manière définitive
...
DO $$
BEGIN
    RAISE NOTICE 'EMERGENCY FIX APPLIED: RLS completely disabled for protocol1_evaluations';
    RAISE NOTICE 'All policies removed and full permissions granted';
    RAISE NOTICE 'Table should now be fully accessible';
END $$;
