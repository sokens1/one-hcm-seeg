-- SOLUTION NUCLÉAIRE - DÉSACTIVATION FORCÉE DE RLS
...
-- 2. FORCER la désactivation de RLS (même si déjà désactivé)
...
DO $$
BEGIN
    RAISE NOTICE 'NUCLEAR FIX APPLIED: RLS completely disabled for protocol1_evaluations';
