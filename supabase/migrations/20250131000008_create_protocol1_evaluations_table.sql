-- Créer la table protocol1_evaluations avec la structure complète
-- Cette migration crée la table manquante avec tous les champs nécessaires

CREATE TABLE IF NOT EXISTS public.protocol1_evaluations (
...
COMMENT ON TABLE public.protocol1_evaluations IS 'Table des évaluations Protocol 1 avec RLS activé et politiques permissives';
