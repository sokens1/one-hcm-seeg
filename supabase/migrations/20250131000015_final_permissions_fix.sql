...
-- 4. Accorder les permissions sur les séquences si elles existent
...
DO $$
BEGIN
    RAISE NOTICE 'FINAL PERMISSIONS FIX APPLIED: protocol1_evaluations is now fully accessible';
