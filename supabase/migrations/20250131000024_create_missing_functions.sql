-- Créer les fonctions RPC manquantes pour les candidatures

-- 1. Fonction pour que les candidats voient leurs propres candidatures
...
BEGIN
  ...
  IF NOT EXISTS(
    ...
    WHERE id = auth.uid() AND role = 'candidat'
  ) THEN
...
-- 2. Fonction pour créer des notifications de candidature
...
-- 3. Fonction pour obtenir les activités du recruteur avec paramètres
