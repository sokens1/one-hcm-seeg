-- Corriger la structure de protocol2_evaluations pour qu'elle soit cohérente avec protocol1_evaluations
...
-- 5. Désactiver RLS pour éviter les problèmes de permissions
