-- Modifier la fonction get_all_recruiter_applications pour accepter le paramètre p_job_offer_id
-- Cette migration corrige la signature de la fonction pour correspondre à l'utilisation du hook
