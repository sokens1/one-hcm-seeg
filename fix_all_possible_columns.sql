-- Script pour ajouter TOUTES les colonnes possibles du protocole 2
-- Copiez et collez ce script dans l'interface Supabase SQL Editor

-- Ajouter toutes les colonnes possibles à protocol2_evaluations
...
AND (column_name LIKE 'simulation_%' OR column_name LIKE '%competences%' OR column_name LIKE '%kcis%' OR column_name LIKE '%kpis%' OR column_name LIKE '%kris%')
